...
/**
 * Mirrors recall-status.schema.json returned by maintenance-vehicle-health-ingestion.
 * Recall status is a first-class structured resource — it is never inferred from
 * free-text maintenance notes.
 */
